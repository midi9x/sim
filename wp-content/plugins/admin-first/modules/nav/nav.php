...
class Admin_Theme_Nav{
	...
	function admin_scripts() {
		...
		wp_enqueue_style( 'admin-theme-icons', $this->setting->plugin_url.( "assets/css/icon.css" ) );
		
		wp_enqueue_style( 'admin-theme-font', $this->setting->plugin_url.( "assets/css/font.css" ) );
