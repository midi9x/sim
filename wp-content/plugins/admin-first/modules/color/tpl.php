	...
	<div class="box-body b-t hide show">
		<div class="color-selector">
			<label class="ui-check ui-check-color ui-check-lg">
				...
				<i style="background-color: #19be96"></i>
			</label>
			<label class="ui-check ui-check-color ui-check-lg">
				<input name="<?php echo $this->setting->setting_name; ?>[default-color]" type="radio" value="color" <?php if ($this->setting->get_setting('default-color') == 'color') echo 'checked="checked" '; ?>>
				<i style="background-color: #2d3c50"></i>
			</label>
			<label class="ui-check ui-check-color ui-check-lg">
				<input name="<?php echo $this->setting->setting_name; ?>[default-color]" type="radio" value="black" <?php if ($this->setting->get_setting('default-color') == 'black') echo 'checked="checked" '; ?>>
				<i style="background-color: #000"></i>
			</label>
			<label class="ui-check ui-check-color ui-check-lg">
				<input name="<?php echo $this->setting->setting_name; ?>[default-color]" type="radio" value="white" <?php if ($this->setting->get_setting('default-color') == 'white') echo 'checked="checked" '; ?>>
